...
If you translate only CPAN(indeed, currently, resource is CPAN only),
you may want to ommit -r option.
...
=head2 ls
  ...
  tran get -r RESOURCE TARGET [VERSION] path/to/anywhere
  tran get --tr translation-repository\n

        -r --resource                    resource. required.
        -t --translation                 list translation directory contents
        --tr --translation_repository    translation repository name(imply -t)
...
=head2 cat
  ...
  tran get -r RESOURCE TARGET [VERSION] path/to/anywhere
        ...
        -r --resource      resource. required.
        -t --translation   show translation file
        -n --number        show content with line number

...
It means that you start to translate Module::Name in the resoruce cpan with traslation repository 'jprp-modules'.
...
If you translate only CPAN, you may want to ommit -r option.
...
If you set your favolite pager in TRAN_PAGER environmental varialbe,
...
show list of files in original repositry.

=item -t/--translation

show list of files in translation repositry.

=item --tr/--translation_repository

As an argument, the name of translation repositry(e.g. jprp-modules)
...
show file content which is in trnslation repository.

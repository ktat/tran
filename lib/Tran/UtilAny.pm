...
sub _kind_exporter {
  ...
  foreach my $class_config (@$kind_config) { # $class_config is class name or array ref
    ...
    ($module_prefix, $config_options) = ('', $module_prefix) if ref $module_prefix;
...
see L<"CREATE YOUR OWN Util::Any">, in detail.
...
=head3 overview
 ...
 $Utils => {
    ...
    # as same as above. if you don't need module_prefix, you can pass hash_ref.
    -kind5 => {Module1 => [qw/func1 func2/] ], ... },
